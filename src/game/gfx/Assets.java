...
public class Assets {
    ...
    public static BufferedImage[] punch1 = new BufferedImage[8],
            ...
            crouch_attack_1 = new BufferedImage[5],
    ...
    public static void init() throws IOException{
            ...
            //loop through frame slices and stores in array
            ...
            for(int i=0; i<8; i++)
                back_flip[i] = ss_back_flip1.crop(83, 125, 83 * i, 0);
            ...
            for(int i=0; i<3; i++)
                crouch_punch[i] = ss_crouch_punch1.crop(89, 72, 89 * i, 0);
