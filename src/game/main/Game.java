...
public class Game extends Canvas implements Runnable{
  ...
  public static final String TITLE  = "Street Fighter II";
	...
	public void render() {		
		...
		// init maps
		ImageIcon ryuStage    = new ImageIcon("src/ryu_stage.png");
		ImageIcon mainStage   = new ImageIcon("src/main_stage.gif");
		ImageIcon forestStage = new ImageIcon("src/forest_stage.gif");
