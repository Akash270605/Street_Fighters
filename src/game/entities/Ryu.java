...
public class Ryu extends Creature{
    ...
    public void tick(){
        ...
        if(y == 280){
            ...
            // if g and not crouching
                ...
                // reset anims that are instantaneous
                anims[CROUCHING]  = false;
    ...
    public void checkWalls(){
        if( x < 0){
            // dont go past left edge
            x= 0;
        }
        
        if(x > Game.WIDTH * 2){
                // DONT  go past right edge
                x = Game.WIDTH * 2;
        }
    }
    ...
    public void collisions(){
        // if rectangle of player collide with enemy rectangle
    ...
    public void render(Graphics g){
        // 2d graphics for transformation
